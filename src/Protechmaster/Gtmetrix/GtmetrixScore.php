...
namespace Protechmaster\Gtmetrix;
...
//    {
//        return "Hello from website rank class";
//    }
    ...
    public function __construct( $username = '', $password = '')  {
        $this->username = Config::get('gtmetrix::GTMETRIX_USERNAME');
        $this->password = Config::get('gtmetrix::GTMETRIX_API');
    }
